              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <Card className="h-full">
                    <CardHeader className="pb-2">
                      <div className="h-12 flex items-center justify-start mb-2">
                        <svg viewBox="0 0 200 40" className="h-8 w-auto text-blue-600" fill="currentColor">
                          <path d="M10.5 10h20v5.5h-13.6v4.6h11.9v5.5h-11.9v10.3h-6.9V10z" />
                          <path d="M34.2 17.9h6.1v3.1c.8-1.2 1.8-2.1 3-2.6 1.1-.5 2.4-.8 3.8-.8.2 0 .5 0 .9.1l-1 6.2c-.5-.1-1-.2-1.5-.2-1.2 0-2.2.4-2.9 1.3-.7.9-1 2.5-1 4.9v6h-6.6V17.9h-3zM61.8 11.9c-3.3 0-6.3 1.5-8.1 3.9v-3.9h-6.6v25.8h6.6V23c0-1.6.6-2.9 1.7-4 1.2-1.1 2.6-1.6 4.3-1.6 1.7 0 3.1.5 4.1 1.6 1.1 1.1 1.6 2.4 1.6 4.1v12.7h6.6V22.7c0-3.4-.9-6-2.8-7.9-1.9-1.9-4.5-2.9-7.4-2.9zM73.1 17.9h6.1v2.9c1-1.1 2-1.9 3.2-2.5.9-.5 2.1-.7 3.5-.7 2.3 0 4.2.7 5.6 2 1.4 1.3 2.1 3.2 2.1 5.8v12.3h-6.6V26c0-1.2-.3-2.1-.9-2.8-.6-.7-1.5-1-2.6-1-1.3 0-2.3.4-3 1.3-.7.9-1.1 2.2-1.1 3.9v10.3h-6.6V17.9h.3zM110.4 17.6c-1.7 0-3.2.2-4.5.7-1.3.5-2.5 1.2-3.4 2.2-1 1-1.7 2.2-2.2 3.6-.5 1.4-.7 3-.7 4.7 0 1.7.2 3.3.7 4.7.5 1.4 1.2 2.6 2.2 3.6 1 1 2.1 1.7 3.4 2.2 1.3.5 2.8.7 4.5.7 1.7 0 3.2-.2 4.5-.7 1.3-.5 2.5-1.2 3.4-2.2 1-1 1.7-2.2 2.2-3.6.5-1.4.7-3 .7-4.7 0-1.7-.2-3.3-.7-4.7-.5-1.4-1.2-2.6-2.2-3.6-1-1-2.1-1.7-3.4-2.2-1.3-.5-2.8-.7-4.5-.7zm0 15.2c-1 0-1.8-.4-2.5-1.1-.7-.8-1-1.7-1-2.9 0-1.1.3-2.1 1-2.9.7-.8 1.5-1.1 2.5-1.1s1.8.4 2.5 1.1c.7.8 1 1.7 1 2.9 0 1.1-.3 2.1-1 2.9-.7.8-1.5 1.1-2.5 1.1zM127.2 10h6.6v6.3h3.9v5.2h-3.9v6.8c0 .7.1 1.3.3 1.6.2.4.7.6 1.5.6.3 0 .5 0 .8-.1.3 0 .6-.1.9-.2l.4 5.1c-.5.2-1.1.3-1.9.5-.7.1-1.5.2-2.2.2-2.4 0-4.2-.6-5.3-1.7-1.1-1.1-1.7-2.9-1.7-5.1v-7.8h-2.2v-5.2h2.2V10h.6zM151.9 10h6.6v13.3l5.2-5.4h7.8l-6.8 6.4 7.5 13.4h-7.5l-4.6-8.6-1.7 1.7v6.8h-6.6V10h.1zM197.2 27.7h-14.7c.1 1.1.5 2 1.2 2.5.6.5 1.5.8 2.6.8.8 0 1.4-.2 1.9-.5.5-.3 1.1-.9 1.8-1.7h6.8c-.6 1.7-1.4 3.1-2.4 4.3-1 1.2-2.3 2.1-3.7 2.6-1.4.6-3 .9-4.8.9-2 0-3.8-.4-5.4-1.1-1.6-.7-2.8-1.9-3.7-3.5-1-1.6-1.4-3.4-1.4-5.5 0-2.3.5-4.2 1.4-5.8 1-1.7 2.3-2.9 3.9-3.7 1.6-.8 3.4-1.2 5.3-1.2 1.9 0 3.6.4 5.2 1.1 1.5.8 2.8 1.9 3.6 3.4.9 1.5 1.3 3.2 1.3 5.3.1.8-.1 1.6-.3 2.1h-1.4z" />
                          <path d="M187.8 24.8c-.1-1.1-.5-1.9-1.2-2.4-.7-.5-1.5-.8-2.5-.8-1.1 0-1.9.3-2.7.8-.7.5-1.1 1.3-1.2 2.4h7.6z" />
                        </svg>
                      </div>
