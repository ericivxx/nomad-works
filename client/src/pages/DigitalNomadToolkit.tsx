              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <CardHeader className="pb-2">
                      <div className="h-12 flex items-center justify-start mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 100" className="h-8 w-auto">
                          <path d="M143 26.8h-14.7v15.4h14.7v-15.4zm0 44.9h-14.7v-13.6h14.7v13.6z" fill="#2d70b3"/>
                          <path d="M283 33.8c-5.3 0-10.3 2-14 5.4-3.8-3.4-8.8-5.4-14-5.4-12 0-21.8 9.8-21.8 21.8s9.8 21.8 21.8 21.8c5.3 0 10.3-2 14-5.4 3.8 3.4 8.8 5.4 14 5.4 12 0 21.8-9.8 21.8-21.8s-9.8-21.8-21.8-21.8z" fill="none"/>
                          <path d="M77.7 53.2c-6.3-5.5-14.5-8.9-23.5-8.9S37 47.7 30.7 53.2c-3.8-5.7-6-12.5-6-19.8C24.7 15 39.7 0 58.2 0s33.5 15 33.5 33.5c-.1 7.3-2.3 14-6 19.7z" fill="#f7a01d"/>
                          <path d="M270.2 57.1c0-6.6-5.3-11.9-11.9-11.9-3.3 0-6.2 1.3-8.4 3.4-2.2-2.1-5.1-3.4-8.4-3.4s-6.2 1.3-8.4 3.4c-2.2-2.1-5.1-3.4-8.4-3.4-6.6 0-11.9 5.3-11.9 11.9s5.3 11.9 11.9 11.9c3.3 0 6.2-1.3 8.4-3.4 2.2 2.1 5.1 3.4 8.4 3.4s6.2-1.3 8.4-3.4c2.2 2.1 5.1 3.4 8.4 3.4 6.5 0 11.9-5.4 11.9-11.9zm-75.6-14.8c-.1 0-.2 0-.3.1h-14.8v-15c0-2.9-2.4-5.3-5.3-5.3-2.9 0-5.3 2.4-5.3 5.3v41.3c0 2.9 2.4 5.3 5.3 5.3 2.9 0 5.3-2.4 5.3-5.3V65.9h13.4c6.5-8.6 10.3-19.2 10.3-30.8 0-12.7-4.7-24.4-12.4-33.4-7.8 9-12.4 20.6-12.4 33.4 0 9 2.4 17.4 6.5 24.8h.7c3.6 0 6.8-1.3 9.4-3.4v-14zm-70.9 2.9c-6.6 0-11.9 5.3-11.9 11.9s5.3 11.9 11.9 11.9 11.9-5.3 11.9-11.9c0-6.6-5.3-11.9-11.9-11.9zm-31.9 0c-6.6 0-11.9 5.3-11.9 11.9s5.3 11.9 11.9 11.9 11.9-5.3 11.9-11.9c0-6.6-5.3-11.9-11.9-11.9zm-40.6 0c-6.6 0-11.9 5.3-11.9 11.9s5.3 11.9 11.9 11.9 11.9-5.3 11.9-11.9c0-6.6-5.3-11.9-11.9-11.9zm40.6-10.4c6.6 0 11.9-5.3 11.9-11.9s-5.3-11.9-11.9-11.9-11.9 5.3-11.9 11.9 5.3 11.9 11.9 11.9zm103.1 29.2c-3.3 0-6.2 1.3-8.4 3.4-2.2-2.1-5.1-3.4-8.4-3.4-6.6 0-11.9 5.3-11.9 11.9s5.3 11.9 11.9 11.9c3.3 0 6.2-1.3 8.4-3.4 2.2 2.1 5.1 3.4 8.4 3.4 6.6 0 11.9-5.3 11.9-11.9s-5.3-11.9-11.9-11.9z" fill="#f7a01d"/>
                          <path d="M179.4 42.3v26.3c0 2.9 2.4 5.3 5.3 5.3 2.9 0 5.3-2.4 5.3-5.3V42.3c0-2.9-2.4-5.3-5.3-5.3-2.9 0-5.3 2.3-5.3 5.3zm27.5-5.3c-2.9 0-5.3 2.4-5.3 5.3v26.3c0 2.9 2.4 5.3 5.3 5.3s5.3-2.4 5.3-5.3V42.3c0-2.9-2.4-5.3-5.3-5.3zm-48.1 0c-2.9 0-5.3 2.4-5.3 5.3v26.3c0 2.9 2.4 5.3 5.3 5.3 2.9 0 5.3-2.4 5.3-5.3V42.3c0-2.9-2.4-5.3-5.3-5.3zm-20.4-10.2c-2.9 0-5.3 2.4-5.3 5.3v41.3c0 2.9 2.4 5.3 5.3 5.3 2.9 0 5.3-2.4 5.3-5.3V32.1c0-2.9-2.4-5.3-5.3-5.3z" fill="#2d70b3"/>
                          <path d="M84 68.5c6.3 5.5 14.5 8.9 23.5 8.9s17.2-3.4 23.5-8.9c3.8 5.7 6 12.5 6 19.8 0 18.5-15 33.5-33.5 33.5s-33.5-15-33.5-33.5c0-7.3 2.2-14 6-19.8z" fill="#f7a01d"/>
                          <path d="M91.8 48.5c3.1 0 5.7-2.5 5.7-5.7 0-3.1-2.5-5.7-5.7-5.7-3.1 0-5.7 2.5-5.7 5.7 0 3.1 2.6 5.7 5.7 5.7z" fill="#2d70b3"/>
                        </svg>
                      </div>
                  ...
                  <Card className="h-full">
                    <CardHeader className="pb-2">
                      <div className="h-12 flex items-center justify-start mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" className="h-8 w-auto">
                          <path d="M100 10C48.6 10 10 48.6 10 100s38.6 90 90 90 90-38.6 90-90S151.4 10 100 10z" fill="none"/>
                          <path d="M150 50L75 150H50l65-100z" fill="#30c2b1"/>
                          <path d="M150 50l-75 100h75z" fill="#11a1cb"/>
                        </svg>
                      </div>
